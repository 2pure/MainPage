...
var PageContent = React.createClass({
    ...
    render: function () {
        ...
        if (this.state.bestActive) {
            bestText = React.createElement(
                "u",
                null,
                bestText
            );
        } else {
            myText = React.createElement(
                "u",
                null,
                myText
            );
        ...
        return React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                ...
                                React.createElement(
                                    NavItem,
                                    { eventKey: 1, onClick: this.handleBest },
                                    bestText
                                ),
                                React.createElement(
                                    NavItem,
                                    { eventKey: 2, onClick: this.handleMy },
                                    myText
                                )
                            ),
                            React.createElement(
                                ...
                                React.createElement(
                                    Button,
                                    { bsStyle: "success", onClick: this.handleCreate },
                                    "Создать Коллекцию"
                                )
                            )
                        )
            ...
            React.createElement(
                ...
                React.createElement(
                    Col,
                    { md: 6, xs: 6 },
                    React.createElement(EndlessScroll, { data: this.state.bestActive ? this.state.BestCards : this.state.MyCards })
                ),
                React.createElement(Col, { md: 2, xs: 2 }),
                React.createElement(
                    Col,
                    { md: 4, xs: 4 },
